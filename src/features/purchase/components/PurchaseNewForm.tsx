...
import type { PurchaseNewSchema } from '../schemas/PurchaseSchema'
...
export const PurchaseNewForm = (props: Props) => {
  return (
...
const EditCard = () => {
  const form = useFormContext<z.infer<typeof PurchaseNewSchema>>()
